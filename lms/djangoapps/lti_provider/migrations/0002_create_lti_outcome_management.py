...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lti_provider_outcomeservice', (
            ...
            ('lis_outcome_service_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('instance_guid', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('consumer_key', self.gf('django.db.models.fields.CharField')(max_length=32, db_index=True)),
        ))
        ...
        db.create_table('lti_provider_gradedassignment', (
            ...
            ('lis_result_sourcedid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, db_index=True)),
        ))
    ...
    models = {
        ...
        'lti_provider.gradedassignment': {
            'Meta': {'object_name': 'GradedAssignment'},
            'course_key': ('xmodule_django.models.CourseKeyField', [], {'max_length': '255', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lis_result_sourcedid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255', 'db_index': 'True'}),
        ...
        'lti_provider.outcomeservice': {
            ...
            'consumer_key': ('django.db.models.fields.CharField', [], {'max_length': '32', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instance_guid': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'lis_outcome_service_url': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
